Can you complete this prompt and fill in the blanks based upon the Nutrition SaaS tracker? I'd like the model the aesthetic of this app after the branding and style guides to Gymshark / NoBull. Contrasting colors, bold fonts, not super wordy. The app's punchline should enforce accountability on the user by having their very own indivudalized AI Agent coach programmed specificaly to their nutritional needs, fitness goals and own biometrics. 
